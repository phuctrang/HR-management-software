<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChucVu.aspx.cs" Inherits="BaiCuoiKy.ChucVu" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td class="auto-style24">
                    &nbsp;&nbsp;
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/pictures/tải xuống.png" Width="82px" BorderStyle="Solid" BorderColor="Red"/>
                </td>
                 <td class="auto-style24">
                    &nbsp;&nbsp;
            ...
            <tr>
                <td class="auto-style23" colspan="5" rowspan="11">
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label1" runat="server" Font-Size="X-Large" style="text-align: center" Text="CHỨC VỤ"></asp:Label>
                    <br />
                    <br />
                    <table style="width: 100%; height: 71px;">
                        <tr>
                            <td class="auto-style33">
                                <asp:Label ID="Label2" runat="server" style="text-align: center" Text="Mã chức vụ"></asp:Label>
                                : </td>
                        ...
                        <tr>
                            <td class="auto-style33">Tên chức vụ: </td>
                            <td class="auto-style29">
                                <asp:TextBox ID="txttcv" runat="server" Width="149px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="6">
                                <asp:GridView ID="GVCV" runat="server" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Height="153px" Width="283px">
